...
def example_usage(model_path: str):
    ...
    classifier = get_trained_model(model_path)
...
# TODO: remove tqdm from word_embeddings.  It's cool but it adds like a full second of overhead
# which would get really annoying if we're doing this with a GUI or something